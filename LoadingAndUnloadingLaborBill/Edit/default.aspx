<%@ Page Title="" Language="C#" MasterPageFile="~/CDB/System/Common/Layout/Master/Panel.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="BPL.Data.INV.LoadingAndUnloadingLaborBill.Edit._default" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Loading & Unloading Labor Bill (Edit)</h3>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtNo" name="txtNo" disabled/>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
